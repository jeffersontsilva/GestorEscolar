class ProfessorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @professor.save
        format.html { redirect_to @professor, notice: 'Professor cadastradado com sucesso.' }
  ...
  private
    ...
    def professor_params
      params.require(:professor).permit(:nome, :dtnascimento, :cpf, :rg, :endereco, :complemento, :cidade, :estado, :telefone, :email)
    end
end
